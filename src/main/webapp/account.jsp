...
<form method="post">
    ...
    <input type="submit" value="Мои заказы" formaction="<%=SHOW_USER_ORDERS%>">
    ...
    <input type="submit" value="Редактировать Категории товаров" formaction="<%=EDIT_PRODUCT_CATEGORIES%>">
    <input type="submit" value="Редактировать продавцов" formaction="<%=EDIT_SELLERS%>">
</form>
